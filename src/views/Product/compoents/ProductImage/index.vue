...
<template>
    <div class="productImg">
        <div class="imageContainer" @mouseleave="handleMouseLeave" @mouseover="handleMouseOver">
            <img :src="imgList[activeIndex]" class="imgBox"  />
            <div class="mask" ref="maskRef" @mousemove="handleMouseMover"></div>
            
        </div>
        <ul class="imgList">
           <li v-for="(v, k) in imgList" :key="v" @click="()=>activeIndex=k" :class="activeIndex===k && 'activer' ">
                <img :src="v"/>
            </li>
        </ul>
