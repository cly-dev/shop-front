                    ...
                    <div class="productInfo">
                        <h1 class="infoTitle">
                            <span class="tips">惠</span>
                                24h内顺丰发货 38礼物TF电光樱桃限定礼盒 口红套装新色</h1>
                            ...
                            <div class="infoDelivery">
                                ...
                                <div class="deliveryInfo text">
                                    <div class="adressContent">浙江宁波 至 福州市 闽侯县</div>
                                    <div>快递:免运费</div>
                                    <div class="time">现在下单预计3后天送达</div>
                                </div>
                            </div>
                            <!-- 颜色 -->
                            <div class="infoColor">
                            ...
                            <div class="infoQuantity">
                                ...
                                <div class="quantityContent">
                                    <div :class="`minusIcon ${count===1 && 'btnDisabled'}`">
                                        <el-icon><Minus /></el-icon>
                                    </div>
                                        <el-select  v-model="count"  style="height: 100%;" class="quantitySelect">、
                                            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                                            </el-option>
                                        </el-select>
                                    <div :class="`plusIcon ${count===productInfo.qty && 'btnDisabled'}`">
                            ...
                            <div class="infoPay">
                                ...
                                <button class="btnBuyAddCart"><el-icon class="cartIcon"><ShoppingTrolley /></el-icon> 加入购物车</button>
                            </div>
                            <!-- 服务承诺 -->
