...
<template>
  ...
  <div class="shop-product">
    <BreadCrumbs
      :nav-list="[{ title: '商品详情', href: '/', disabled: true }]"
    ></BreadCrumbs>
        ...
        <el-col :span="13">
          <div class="productInfo">
            ...
            <h2 class="infoItemId">
              ...
              <el-icon class="btnCopy"
                ><CopyDocument @click="() => copyAction('1435312315123252')"
              /></el-icon>
            </h2>
            <!-- 配送 -->
            ...
            <div class="infoQuantity">
              ...
              <div class="quantityContent">
                ...
                <div
                  :class="`plusIcon ${
                    count === productInfo.qty && 'btnDisabled'
                  }`"
                >
