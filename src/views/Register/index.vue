      ...
      <section class="register-content">
        ...
        <section class="content-mainer">
          ...
          <section class="password-content">
            ...
            />
            <!-- 提示 -->
            <span class="password-tips" style="position: absolute"
              >密码在6~12位之间,包含英文</span
            >
          </section>
          ...
          <section class="checkCode-content">
            ...
            />
            <button
              :class="['btn-cotent', isLoading ? 'quiet' : 'activer']"
              :disabled="isLoading"
              @click="handleGetCode"
            >
          ...
          <section class="btn-content">
            <el-button type="button" class="btn-login" @click="handleRegister">
              注册
            </el-button>
            <el-button type="button" class="btn-cancel" @click="Router.push('/login')">
              取消
            </el-button>
          </section>
        </section>
